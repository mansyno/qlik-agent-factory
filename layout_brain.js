...
- "measures": An array of exact 'id's from your "measures" array (or use "masterMeasureId" for legacy single-measure widgets).
- "dimensions": An array of exact 'id's from your "dimensions" array (optional for kpi, or use "masterDimensionId" for legacy single-dimension widgets).
- NOTE: The "table" template supports multiple dimensions and measures (arrays). Other templates currently support only one (can use array of length 1 or the legacy fields).
...
Example output structure:
{
  "masterItems": {
    "dimensions": [
      ...
      { "id": "Dim_Product", "title": "Product", "expression": "ProductName" }
    ],
    "measures": [
      { "id": "Sum_Sales", "title": "Total Sales", "expression": "Sum(TotalSales)" },
      { "id": "Avg_Margin", "title": "Average Margin", "expression": "Avg(Margin)" }
    ]
  },
  "blueprint": [
    {
    ...
    },
    {
      ...
      "dimensions": ["Dim_Category", "Dim_Product"],
      "measures": ["Sum_Sales", "Avg_Margin"],
      "grid": { "x": 0, "y": 12, "width": 24, "height": 8 }
    }
  ]
}
