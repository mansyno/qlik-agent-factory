...
const partResult = classifyData(partProfile);
...
const citiesResult = classifyData(citiesProfile);
...
const coResult = classifyData(coProfile);
...
const lcResult = classifyData(lcProfile);
